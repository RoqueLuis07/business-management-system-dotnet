...
{
    public static class UpdateAccessoryInWorkOrder
    {
        public record Command(Guid WorkOrderId, Guid AccessoryId, bool IsPresent, string? Condition);
        ...
        public static async Task HandleAsync(IWorkOrderRepository repo, Command cmd, CancellationToken ct)
        {
            ...
            wo.UpdateAccessory(cmd.AccessoryId, cmd.IsPresent, cmd.Condition);
